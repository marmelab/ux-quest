...
export const breadcrumbNav: MiniAppDefinition = {
  ...
  expectedAnswers: [
    ...
    "The breadcrumbs all look the same, can't tell which one is the current page.",
    "No way to distinguish clickable breadcrumbs from the active one.",
    "The current location in the breadcrumb trail isn't highlighted or styled differently.",
